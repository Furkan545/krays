...
module.exports = (client) => {
  ...
  app.get("/autherror", (req, res) => {
    ...
    client.channels.get("572884179063406603").send("Web Panelinde bağlantı hatası oluştu! Kişi giriş yapamıyor tekrar denemeli! Büyük bir sorun değil.")
  });
  ...
  app.get("/dashboard/:guildID/reset", checkAuth, async (req, res) => {
    ...
    client.ayar.delete(`prefix_${guild.id}`) //ayarları silme kısmı client.ayar yazdım çünkü bot.js de db yi o şekilde tanımlamıştım
