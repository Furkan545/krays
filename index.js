...
client.on('guildCreate', async guild => {
  ...
  var guildhook = new Discord.WebhookClient("573497909618671636", "5C5K4mIFhpPAaDOfUi2IkFf6fnBc7fQdH8emnFtRTCgTI4C4_ma2392W8lIudbBk42T7")
...
function generateMessages(){
    ...
    for (let role of roles) messages.push(`Kayıt Olmak İçin **"${reactions}"** Emojisine Tıkla!`); //DONT CHANGE THIS
    return messages;
}
...
client.login("NTc0MjY0OTUyNzgxNzk5NDY1.XM238A.ZLy7tRkCAC3bpEiUBfNNbKnS1tw")