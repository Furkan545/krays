...
module.exports.run = async (bot, message, args) => {
    ...
    .addField(`🕹 Sunucu komutları 🕹`, 'k+ayarlar: `Sunucu ayarlarını gösterir.` \nk+davet-sıralaması: `Sunucunuza en çok kullanıcı getirenleri sıralar.` \nk+emojiler: `Bulunduğunuz sunucudaki emojileri gösterir.` \nk+oylama: `Sunucunuzda oylama yapmanızı sağlar.` \nk+roller: `Bulunduğunuz sunucudaki rolleri gösterir.` \nk+sunucu-bilgi: `Bulunduğunuz sunucu hakkında bilgi verir.`\nk+sunucutanıt:`12 Saate Bir Sunucunuzu tanıtırsınız.`\nk+namaz: `Şehirlere Göre Namaz Vakti`')
