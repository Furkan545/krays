...
let mesaj = args.slice(0).join(' ');
  if (mesaj.length < 1) return message.channel.send(new Discord.RichEmbed().setColor("RANDOM").setDescription('/hatabildir <hata> şeklinde yaz.'));
...
return client.channels.get("573254762267541645").send(tavsiye);
};
...
exports.help = {
  name: 'hatabildir',
  description: 'Botta bulunan hatayı sahibine gönderir.',
